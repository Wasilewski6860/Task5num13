...
//                tree = (SimpleBSTree<String>) node;
                ...
                SimpleBinaryTree<String> tree = new SimpleBinaryTree<>(String::toString);
                tree.fromBracketNotation(textFieldBracketNotationTree.getText());
                BinaryTree.TreeNode<String> node = BSTreeAlgorithms.findLargestBST(tree.getRoot());
                tree.fromBracketNotation(node.toBracketStr());
                this.tree = tree;
                repaintTree();
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        textFieldBracketNotationTree.setText("Владислав (Леслав (Владимир (Богдан), Евгений), Николай (, Станислав (Анна, Ярослав)))");
